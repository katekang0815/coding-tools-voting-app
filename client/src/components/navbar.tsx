            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
              {categories.map((category) => (
                <a
                  key={category.name}
                  href={category.href}
                  className="text-gray-700 dark:text-gray-300 hover:text-[var(--brand-secondary)] block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200"
              ...
              <div className="pt-2">
                <Button
                  size="sm"
                  className="w-full bg-[var(--brand-secondary)] hover:bg-[hsl(244,79%,52%)] text-white font-semibold"
                >
                  Get Started
                </Button>
              </div>
