  ...
  return (
    <div className="tool-item flex flex-col items-center group opacity-100">
      <div className="relative p-6 bg-gray-900 rounded-lg hover:bg-gray-800 transition-all duration-300">
        ...
        >
          <Heart className="w-6 h-6 stroke-2 transition-all duration-300 fill-none stroke-red-500 hover:fill-red-500" />
        </button>
        {tool.likeCount > 0 && (
    ...
    >
      {sortedTools.map((tool) => {
        ...
        return (
          ...
          >
            <div className="relative p-3 sm:p-4 md:p-5 lg:p-6 bg-gray-900 rounded-lg hover:bg-gray-800 transition-all duration-300 w-full">
              <div className="flex flex-col items-center">
                <div
              ...
              >
                <Heart className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 stroke-2 transition-all duration-300 fill-none stroke-red-500 hover:fill-red-500" />
              </button>
              {tool.likeCount > 0 && (
